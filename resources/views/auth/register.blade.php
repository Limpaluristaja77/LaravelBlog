        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="text" name="name" class="input" value="{{ old('name') }}" placeholder="@lang('Name')"
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="email" name="email" class="input" value="{{ old('email') }}" placeholder="@lang('Email')"
